...
function setKeymap() {
	sed -i "61s/$/\n# Settigns generated by xmonad-install.sh\nsetxkbmap ${KEYMAP} # Set xkb map\nxrandr --output DVI-I-0 --mode 1920x1080 --pos 1080x400 --output DVI-D-0 --mode 1920x1080 --rotate left --pos 0x0 --output HDMI-0 --preferred --pos 3000x400 # Set monitor layouts\n/" "$LIGHTDM_XSESSION_FILE_PATH"
}
